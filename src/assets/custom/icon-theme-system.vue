...
<template>
  <svg
    ...
    :class="cn('overflow-hidden rounded-[6px]', 'fill-primary stroke-primary group-data-[state=unchecked]:fill-muted-foreground group-data-[state=unchecked]:stroke-muted-foreground', $props.class)"
    v-bind="$attrs"
  >
    ...
    <g><circle cx='62.74' cy='16.32' r='8' :opacity="0.25" /><path d='M62.74 16.32l4.1-6.87c1.19.71 2.18 1.72 2.86 2.92s1.04 2.57 1.04 3.95h-8z' :opacity="0.45" /></g>
