...
<template>
  <svg data-name='icon-layout-compact' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 79.86 51.14' v-bind='$attrs'>
    ...
    <g :opacity="0.5"><circle cx='62.16' cy='18.63' r='7.5' /><path d='M62.16 11.63c3.86 0 7 3.14 7 7s-3.14 7-7 7-7-3.14-7-7 3.14-7 7-7m0-1c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8z' /></g>
    <g :opacity="0.74"><path d='M63.04 18.13l3.38-5.67c.93.64 1.7 1.48 2.26 2.47.56.98.89 2.08.96 3.21h-6.6z' /><path d='M66.57 13.19a6.977 6.977 0 012.52 4.44h-5.17l2.65-4.44m-.31-1.43l-4.1 6.87h8c0-1.39-.36-2.75-1.04-3.95a8.007 8.007 0 00-2.86-2.92z' /></g>
  </svg>
</template>
